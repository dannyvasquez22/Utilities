...
public class FileUtils {
	...
	/**
	 * Returns the value of java.io.tmpdir system property. It appends separator if
	 ...
	 *
	 * @param uri
	 * @return Extension including the dot("."); "" if there is no extension; null
	 *         if uri was null.
	 */
	 ...
	 *            the second file
	 * @param charsetName
	 *            the character encoding to be used. May be null, in which case the
