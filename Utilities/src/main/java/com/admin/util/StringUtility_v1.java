...
public class StringUtility_v1 {
	...
	/**
	 * Converts a 2 dimensional array into a map where the first dimension is 2 cell
	 * String array containing key and value respectively. Any array with fewer than
	 * 2 elements is ignored.
	 * 
	 * @param array
	...
	/**
	 * Searches through a given String array and returns an element that starts with
	 * the supplied startsWith string. This method ignores the case. If no match can
	 * be found then an empty String is returned.
	 * 
	 * @param array
	 ...
	 *         String if one cannot be found. If multiple Strings match, then the
	 *         first one in the array will be returned.
	 */
	 ...
	 * @return Index of the matching element, or -1 if no match is found. If there
	 *         are multiple matches then the index of the first match is returned.
	 */
	...
	/**
	 * Keeps prepending a given prependChar to an initialInt until it reaches the
	 * targetLength and returns the result. If initialInt is null then null is
	 * returned.
	 * 
	 * @param prependChar
	 *            The char to prepend
	 ...
	 * @param initialInt
	 *            The initial Integer
	 * @return The initialInt padded out with the prependChar at the beginning of
	 *         the string until it reaches the targetLength
	 */
	...
	/**
	 * Keeps prepending a given prependChar to an initialString until it reaches the
	 * targetLength and returns the result. If initialString is null then null is
	 * returned.
	 * 
	 * @param prependChar
	 *            The char to prepend
	 ...
	 * @param initialString
	 *            The initiatlString
	 * @return The initialString padded out with the prependChar at the beginning of
	 *         the string until it reaches the targetLength
	 */
	...
	/**
	 * If a given string is longer than maxLength then it is truncated. For example
	 * if str="hamburger" and maxLength=3 then "ham" will be returned.
	 * 
	 * @param str
	 *            The str to be truncated. If this is null or equal to or shorter
	 *            than maxLength then it is returned whithout modification.
	 * @param maxLength
	...
	/**
	 * This String utility or util method can be used to merge 2 arrays of string
	 * values. If the input arrays are like this array1 = {"a", "b" , "c"} array2 =
	 * {"c", "d", "e"} Then the output array will have {"a", "b" , "c", "d", "e"}
	 * 
